...
const Register = () => {
  return (
    ...
    <div className="relative py-6 bg-primary/10">
        <div className="container relative m-auto px-6 text-gray-500 md:px-12 xl:px-40">
            <div className="m-auto space-y-8 md:w-8/12 lg:w-6/12 xl:w-6/12">
                <a href="/">
                    <img src={Logo} loading="lazy" className="ml-4" alt="tailus logo" />
                </a>
                <div className="rounded-3xl border border-gray-100 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl shadow-gray-600/10 backdrop-blur-2xl">
                    <div className="p-8 py-12 sm:p-16">
                            <h2 className="mb-8 text-2xl font-bold text-gray-800 dark:text-white">Inscription</h2>
                            <form action="" className="space-y-8">
                                <div className="space-y-2">
                                    <label for="text" className="text-gray-600 dark:text-gray-300">nom d'utilisateur</label>
                                    <input
                                    type="text"
                                    name="email"
                                    id="text"
