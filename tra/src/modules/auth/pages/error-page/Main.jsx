      ...
      <div>
        ...
        <div className="container">
          ...
          <div className="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
            ...
            <div className="text-white mt-10 lg:mt-0 bg-slate-600 rounded-xl p-6">
              ...
              <Link to='/' className="intro-x btn py-3 px-4 text-white border-white dark:border-darkmode-400 dark:text-slate-200 mt-10">
                Back to Home
              </Link>
            </div>
          </div>
