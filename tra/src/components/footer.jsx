        ...
        <footer id='footer' className="mt-auto w-full max-w-full py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-tert">
            <div className="text-center"> 
                ...
                <div className="mt-3 space-x-2">
                    <a className="inline-flex justify-center items-center w-10 h-10 text-center text-secondary hover:bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition" href="#">
